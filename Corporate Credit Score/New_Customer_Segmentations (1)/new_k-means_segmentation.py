...
storage_container_name = "risk-datalake"

temp_dir_url =  "wasbs://risk-datalake@ubariskdl.blob.core.windows.net/".format(storage_container_name, storage_account_name)
